...
<head>
  ...
  <title>Edgar Corp | Register User</title>
  ...
  <body class="bg-light-gray" id="body">
                ...
                <div class="card-header bg-primary">
                  <div class="app-brand">
                    <a href="/index.html">
                      ...
                      <span class="brand-name">Edgar Corp Dashboard</span>
                    </a>
                  </div>
                </div>
                <div class="card-body p-5">
                  <h4 class="text-dark mb-5">Register Now</h4>
                  ...
                  <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-12 mb-4">
                        <input type="email" class="form-control input-lg" id="email" aria-describedby="emailHelp" placeholder="Email Address"
          ...
          <div class="copyright pl-0">
            <p class="text-center">Copyright &copy; 2022 | Edgar Corp Dashboard |
                <a class="text-primary" href="http://www.github.com/edgarowarwo" target="_blank">Github</a>.
              </p>
          </div>
        </div>
</body>
