      ...
      <div class="row portfolio-container" data-aos="fade-up">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-web">
          ...
          <div class="portfolio-info">
            <h4>Web 3</h4>
            <p>Web</p>
            <a href="{{ asset('frontend/') }}" data-gall="portfolioGallery" class="venobox preview-link" title="Web 3"><i class="bx bx-plus"></i></a>
            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
          ...
          <div class="portfolio-info">
            <h4>App 2</h4>
            <p>App</p>
            <a href="{{ asset('frontend/') }}" data-gall="portfolioGallery" class="venobox preview-link" title="App 2"><i class="bx bx-plus"></i></a>
            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
          ...
          <div class="portfolio-info">
            <h4>Card 2</h4>
            <p>Card</p>
            <a href="{{ asset('frontend/') }}" data-gall="portfolioGallery" class="venobox preview-link" title="Card 2"><i class="bx bx-plus"></i></a>
            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
          </div>
        </div>
      ...
      <div class="row no-gutters clients-wrap clearfix" data-aos="fade-up">
        ...
        <div class="col-lg-3 col-md-4 col-6">
          <div class="client-logo">
            <img src="{{ asset($brand->brand_image) }}" alt="{{ $brand->brand_name }}" class="img-fluid" alt="" />
          </div>
        </div>
        @endforeach
